...
from trainers.basic_trainer import BasicTrainTask, Context
...
class DeepEdit(BasicTrainTask):
    ...
    # Modify this transformations for the ones in ROG 
    def train_pre_transforms(self, context: Context):
        return [
            ...
            # AddGuidanceSignalDeepEditd(keys="image", guidance="guidance", sigma=1, number_intensity_ch=self.number_intensity_ch),
            # #
            ToTensord(keys=("image", "label")),
