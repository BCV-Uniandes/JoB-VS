...
from lib.infers.deepedit import DeepEdit
...
class MyApp(MONAILabelApp):
        ...
        for n in models:
            for k, v in configs.items():
                ...
                if n == k or n == "all":
                    ...
                    self.models[k].init(k, self.model_dir,
                                        conf, self.planner,
                                        studies=studies
                                        )
    ...
    def init_infers(self) -> Dict[str, InferTask]:
        ...
        #     {
        #     "rog": DeepEdit(
        #         path= infers['deepedit_seg'].path,
        #         network= infers['deepedit_seg'].network,
        #         labels= infers['deepedit_seg'].labels,
        #         preload= False,
        #         spatial_size=infers['deepedit_seg'].spatial_size,
        #         threshold=self.models['deepedit'].train().threshold,)
        #     })
